...
const (
	...
	DaemonService_VUp_FullMethodName                        = "/daemon.DaemonService/VUp"
	DaemonService_VDown_FullMethodName                      = "/daemon.DaemonService/VDown"
	DaemonService_VStatus_FullMethodName                    = "/daemon.DaemonService/VStatus"
	DaemonService_VConfig_FullMethodName                    = "/daemon.DaemonService/VConfig"
)
...
type DaemonServiceClient interface {
	...
	// V2Ray management RPCs
	// VUp starts V2Ray connection
	VUp(ctx context.Context, in *VUpRequest, opts ...grpc.CallOption) (*VUpResponse, error)
	// VDown stops V2Ray connection
	VDown(ctx context.Context, in *VDownRequest, opts ...grpc.CallOption) (*VDownResponse, error)
	// VStatus returns V2Ray connection status
	VStatus(ctx context.Context, in *VStatusRequest, opts ...grpc.CallOption) (*VStatusResponse, error)
	// VConfig updates V2Ray configuration
	VConfig(ctx context.Context, in *VConfigRequest, opts ...grpc.CallOption) (*VConfigResponse, error)
}
...
func (c *daemonServiceClient) VUp(ctx context.Context, in *VUpRequest, opts ...grpc.CallOption) (*VUpResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VUpResponse)
	err := c.cc.Invoke(ctx, DaemonService_VUp_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonServiceClient) VDown(ctx context.Context, in *VDownRequest, opts ...grpc.CallOption) (*VDownResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VDownResponse)
	err := c.cc.Invoke(ctx, DaemonService_VDown_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonServiceClient) VStatus(ctx context.Context, in *VStatusRequest, opts ...grpc.CallOption) (*VStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VStatusResponse)
	err := c.cc.Invoke(ctx, DaemonService_VStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *daemonServiceClient) VConfig(ctx context.Context, in *VConfigRequest, opts ...grpc.CallOption) (*VConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VConfigResponse)
	err := c.cc.Invoke(ctx, DaemonService_VConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DaemonServiceServer interface {
	...
	// V2Ray management RPCs
	// VUp starts V2Ray connection
	VUp(context.Context, *VUpRequest) (*VUpResponse, error)
	// VDown stops V2Ray connection
	VDown(context.Context, *VDownRequest) (*VDownResponse, error)
	// VStatus returns V2Ray connection status
	VStatus(context.Context, *VStatusRequest) (*VStatusResponse, error)
	// VConfig updates V2Ray configuration
	VConfig(context.Context, *VConfigRequest) (*VConfigResponse, error)
...
func (UnimplementedDaemonServiceServer) VUp(context.Context, *VUpRequest) (*VUpResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VUp not implemented")
}
func (UnimplementedDaemonServiceServer) VDown(context.Context, *VDownRequest) (*VDownResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VDown not implemented")
}
func (UnimplementedDaemonServiceServer) VStatus(context.Context, *VStatusRequest) (*VStatusResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VStatus not implemented")
}
func (UnimplementedDaemonServiceServer) VConfig(context.Context, *VConfigRequest) (*VConfigResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VConfig not implemented")
}
...
func _DaemonService_VUp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VUpRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).VUp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_VUp_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).VUp(ctx, req.(*VUpRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DaemonService_VDown_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VDownRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).VDown(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_VDown_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).VDown(ctx, req.(*VDownRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DaemonService_VStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).VStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_VStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).VStatus(ctx, req.(*VStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _DaemonService_VConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VConfigRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DaemonServiceServer).VConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DaemonService_VConfig_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaemonServiceServer).VConfig(ctx, req.(*VConfigRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var DaemonService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VUp",
			Handler:    _DaemonService_VUp_Handler,
		},
		{
			MethodName: "VDown",
			Handler:    _DaemonService_VDown_Handler,
		},
		{
			MethodName: "VStatus",
			Handler:    _DaemonService_VStatus_Handler,
		},
		{
			MethodName: "VConfig",
			Handler:    _DaemonService_VConfig_Handler,
		},
	},
